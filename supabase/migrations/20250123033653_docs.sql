...
CREATE POLICY "Allow update of unsigned documents" ON documents FOR UPDATE USING (true);
CREATE POLICY "Allow delete of unsigned documents" ON documents FOR DELETE USING (true);

...
function Docker() {
  ...
  return (
    <StaticDock direction="middle">
      ...
      <StaticDockIcon>
        <DockItem href="https://twitter.com" content="X">
          <XIcon className="size-5" />
        </DockItem>
      </StaticDockIcon>
      <StaticDockIcon>
        <DockItem href="https://github.com/DocuSol" content="GitHub">
          <Github className="size-5" />
        </DockItem>
      </StaticDockIcon>
      <StaticDockIcon>
        <DockItem href="#" content="PumpFun">
          <Pill className="size-5" />
        </DockItem>
      </StaticDockIcon>
      <StaticDockIcon>
        <DockItem href="#" content="DexScreener">
          <svg
